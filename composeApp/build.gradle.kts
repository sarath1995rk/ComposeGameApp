...
android {
    namespace = "com.eample.composegameapp"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.eample.composegameapp"
...
compose.desktop {
    application {
        mainClass = "com.eample.composegameapp.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.eample.composegameapp"
